...
function render() {
    ...
    // NEW: Higher-contrast, visually distinct icons
    const deleteIcon = `
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="white" class="w-6 h-6">
            <path d="M3 5a1 1 0 011-1h16a1 1 0 011 1v1a1 1 0 01-1 1H4a1 1 0 01-1-1V5zm3 3h12v11a2 2 0 01-2 2H8a2 2 0 01-2-2V8zm5 1.5a.5.5 0 00-1 0v8a.5.5 0 001 0v-8zm4 0a.5.5 0 00-1 0v8a.5.5 0 001 0v-8z"/>
        </svg>
    `;
    const favoriteIcon = `
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="white" class="w-6 h-6">
